...
const BankConnectionSchema: Schema<IBankConnection> = new Schema(
  {
    ...
    provider: { type: String, enum: ["plaid", "yapily"], default: "plaid", required: true },
    ...
    linkSessionId: { type: String, trim: true },
    syncCursor: { type: String, trim: true },
