    ...
    <div className={styles.page}>
      ...
      <section className={styles.notes}>
        ...
        <ul>
          ...
          <li>Starter is built for manual entry, Smart adds synced tracking with forecasting and breakdown views, and Pro adds exports, advanced personalization, and a precision event planning workspace.</li>
